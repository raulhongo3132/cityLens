        ...
        <div class="mt-8 w-full card-lugar shadow-2xl relative animate-fade-in border-t-[6px] border-t-[#27dae0] rounded-sm">
            <div class="p-8 md:p-12">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3 w-100 font-sans-ui">
                    <a href="city.html?name=${encodeURIComponent(data.ciudad)}" class="flex-1 text-center px-4 py-3 text-[14px] md:text-[16px] font-black tracking-widest bg-[#27dae0] text-white shadow-md hover:bg-[#1cb0b5] uppercase transition-all text-decoration-none border-0 rounded-sm">
